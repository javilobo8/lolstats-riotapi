...
describe('RiotApi', () => {
  describe('Create instance with apikey', () => {
    ...
    it('should get recent champion list', (done) => {
      RiotApi.getChampionList(apikey)
        .then(({data}) => {
    ...
    it('should contain LeagueV3 instance', (done) => {
      expect(api.LeagueV3).to.be.instanceOf(LeagueV3);
      done();
    });
  });
